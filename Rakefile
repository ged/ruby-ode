...
PROJECT_NAME  = 'Ruby-ODE'
PKG_NAME      = PROJECT_NAME.downcase
PKG_SUMMARY   = 'a Ruby binding for the Open Dynamics Engine.'

# Cruisecontrol stuff
CC_BUILD_LABEL     = ENV['CC_BUILD_LABEL']
CC_BUILD_ARTIFACTS = ENV['CC_BUILD_ARTIFACTS'] || 'artifacts'

VERSION_FILE  = LIBDIR + 'ode.rb'
...
RDOC_OPTIONS = [
	...
	'-m', 'README',
	'-t', PKG_NAME,
	'-W', 'http://deveiate.org/projects/Ruby-ODE/browser/'
  ]
...
GEMSPEC   = Gem::Specification.new do |gem|
	...
	gem.description       = [
		"Ruby-ODE is a Ruby binding for the Open Dynamics Engine, written in C.",
  	  ].join( "\n" )

	gem.authors           = "Michael Granger"
	gem.email             = ["ged@FaerieMUD.org"]
	gem.homepage          = 'http://deveiate.org/projects/Ruby-ODE'
